              ...
              child: Column(
                children: [
                        ...
                        children: [
                          ...
                          Container(
                            child: Text(
                              "23" + "°",
                              style: GoogleFonts.nunito(
                                  color: Colors.white, fontSize: 100,fontWeight:FontWeight.w600),
                            ),
                          ),
                          Container(
                            child: Text(
                  ...
                  Padding(
                    ...
                    child: Container(
                      child: Row(
                        children: [
                          Container(
                            child: Text('Today',style: GoogleFonts.nunito(
                                color: Colors.white, fontSize: 15),),
                          ),
                          SizedBox(
                            width: 200,
                          ...
                          Container(
                            child: Text('7-Day Forecasts',style: GoogleFonts.nunito(
                                color: Colors.white, fontSize: 15),),
                          )
                        ],
                      ),
                  ...
                  Padding(
                    ...
                    child: Container(
                      child: Row(
                        children: [
                          Container(
                            child: Text('Other Cities',style: GoogleFonts.nunito(
                                color: Colors.white, fontSize: 15),),
                          ),
                          SizedBox(
                            width: 240,
                  ...
                  Padding(
                    ...
                    child: Container(height:130 ,child: SelectedCity()),
                  ),
                ],
              ),
            ),
